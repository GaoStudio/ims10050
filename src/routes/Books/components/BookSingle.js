...
import {
  Form, Input, Row, Col, Select, Cascader, Button, Card, InputNumber, Radio,
} from 'antd';
...
@Form.create()
export default class BookSingle extends PureComponent {
  handleSubmit = (e) => {
    e.preventDefault();
    ...
    return (
      <Card bordered>
        ...
        >
          ...
          <Form.Item
            {...formItemLayout}
            label={<span>简单描述<em className={styles.optional}>（选填）</em></span>}
          >
